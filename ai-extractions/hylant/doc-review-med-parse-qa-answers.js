...
const FIELD_CFG_LIST = [
  // Eligibility Language Q&A
  {
    ...
    Q: 'DR_MEligibilityLanguageQ',
    A: 'DR_MEligibilityLanguageA',
    store: 'DR_MEligibilityLanguageQA'
  },
  // Termination Provision Q&A
  {
    title: 'Termination Provision Q&A',
    Q: 'DR_MTerminationProvisionQ',
    A: 'DR_MTerminationProvisionA',
    store: 'DR_MTerminationProvisionQA'
  },
  // Exclusions & Limitations Q&A
  {
    title: 'Exclusions & Limitations Q&A',
    Q: 'DR_MExclusionLimitationQ',
    A: 'DR_MExclusionLimitationA',
    store: 'DR_MExclusionLimitationQA'
  }
];
